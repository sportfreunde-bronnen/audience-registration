        ...
        <form method="POST" action="{{ route('login') }}" class="w-full">
            ...
            <div class="flex flex-wrap -mx-3">
                ...
                <div class="w-full px-3 mb-6">
                    ...
                    <input id="txt-password" name="password" required class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="text">
                </div>
            </div>
            <div class="flex mb-6">
