...
<head>
    ...
    <title>{{ config('app.name', 'Laravel') }} - @yield('title', 'Start')</title>
                    ...
                    <div class="flex items-center justify-between h-16">
                        <div class="flex items-center">
                            <div class="flex-shrink-0 text-white">
                                <span class="text-lg"><a href="/">Sportfreunde Bronnen</a></span>
                                <span class="text-xs block">Besucheranmeldung</span>
                            </div>
                            @auth
                            <div class="hidden md:block">
                                <div class="ml-10 flex items-baseline">
                                    <a href="#" class="px-3 py-2 rounded-md text-sm font-medium text-white bg-gray-900 focus:outline-none focus:text-white focus:bg-gray-700">Seite A</a>
                                    <a href="#" class="ml-4 px-3 py-2 rounded-md text-sm font-medium text-gray-300 hover:text-white hover:bg-gray-700 focus:outline-none focus:text-white focus:bg-gray-700">Seite B</a>
                                </div>
                            </div>
                            @endauth
                        </div>
