    ...
    <div class="mx-1 md:mx-20 xl:mx-40 rounded bg-gray-100 text-sm shadow-xs px-5 py-3 text-gray-800">
            ...
            <form class="w-full" method="POST" action="{{ route('registration.store') }}">
                ...
                <div class="flex flex-wrap -mx-3 mb-2">
                    <div class="w-full px-3 mb-6">
                        ...
                        <div class="relative">
                            <select class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="select-event" name="event">
                                @foreach ($events as $event)
                                    <option value="{{ $event->id }}">(@datetime($event->date_start) - {{ $event->name }})</option>
                                @endforeach
                            </select>
                    ...
                    <div class="w-full px-3 mb-6">
                        ...
                        <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="txt-amount" name="amount" type="number" min="1" max="20" value="1">
                ...
                <div class="flex flex-wrap -mx-3 md:mb-6">
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                        ...
                        <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 @error('email') border-red-500 @enderror" id="txt-phone" name="phone" type="text" placeholder="Telefonnummer">
                    </div>
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
        ...
        @else
            <div class="flex items-center bg-gray-800 text-white text-sm px-4 py-3" role="alert">
                ...
                <p>Aus organistatorischen Gründen können wir für das Freundschaftsspiel am 22.08.2020 um 17.00 Uhr gegen die SGM Erlenmoos leider keine Online Registrierung für Besucher anbieten.</p>
            </div>
            <!--
            <div class="flex items-center bg-gray-800 text-white text-sm px-4 py-3" role="alert">
                <svg class="fill-current w-4 h-4 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M12.432 0c1.34 0 2.01.912 2.01 1.957 0 1.305-1.164 2.512-2.679 2.512-1.269 0-2.009-.75-1.974-1.99C9.789 1.436 10.67 0 12.432 0zM8.309 20c-1.058 0-1.833-.652-1.093-3.524l1.214-5.092c.211-.814.246-1.141 0-1.141-.317 0-1.689.562-2.502 1.117l-.528-.88c2.572-2.186 5.531-3.467 6.801-3.467 1.057 0 1.233 1.273.705 3.23l-1.391 5.352c-.246.945-.141 1.271.106 1.271.317 0 1.357-.392 2.379-1.207l.6.814C12.098 19.02 9.365 20 8.309 20z"/></svg>
